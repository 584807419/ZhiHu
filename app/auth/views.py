...
from .forms import LoginForm,RegisteationForm,ChangePasswordForm,PasswordResetForm,PasswordResetRequestForm,ChangeEmailForm
from .. import db
...
def register():
    ...
    return render_template('auth/register1.html', form=form)#知乎注册样式
...
def password_reset_request():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            send_email(user.email,u'重置你的密码','auth/email/reset_passord',user=user,token=token,next=request.args.get('next'))
